...
#ifndef _MTKBSP_TK_SYSLIB_H_
#define _MTKBSP_TK_SYSLIB_H_

/* Note: μT-Kernel 3.0 BSP uses <stddef.h> in the development environment. */
#include <stddef.h>
...
#define SYSLIB_SYSDEP()		SYSLIB_PATH(tk/sysdepend/TARGET_GRP_DIR/syslib.h)
...
/* Note: μT-Kernel 3.0 BSP uses <stddef.h> in the development environment.
	Therefore, "size_t" is not self-defined.
 */
