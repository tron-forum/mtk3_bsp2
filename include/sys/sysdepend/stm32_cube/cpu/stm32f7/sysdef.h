 ...
 *	sysdef.h
 *
 *	System dependencies definition (STM32F7 depended)
...
/* STM32H76xxx & F77xxx Internal SRAM1   0x20020000 - 0x2007BFFF  (Size 368KB)
 *                      Internal SRAM2   0x2007C000 - 0x2007FFFF  (Size 16KB)
 */
#define INTERNAL_RAM_START      0x20020000
...
#define N_INTVEC		110	/* Number of Interrupt vectors */
 ...
 */
#define	N_EXTIEVT		25	/*  Number of EXTI event input */
...
#define RCC_APB1ENR	(MTK_RCC_BASE + 0x0040)	/* RCC APB1 clock register */
...
#define	MTK_GPIOI_BASE	0x40022000
#define	MTK_GPIOJ_BASE	0x40022400
#define	MTK_GPIOK_BASE	0x40022800
