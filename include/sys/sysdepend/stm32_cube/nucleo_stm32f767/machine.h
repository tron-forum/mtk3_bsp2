 ...
 *	machine.h
 *
 *	Machine type definition (NUCLEO STM32H767)
 */
...
/* ----- MUCLEO STM32F767 (CPU: STM32F767ZI) definition ----- */
#define MTKBSP_STM32CUBE		1	/* Target system   : STM32Cube */
#define MTKBSP_NUCLEO_STM32F767		1	/* Target Board    : NUCLEO STM32F767 */

#define MTKBSP_CPU_STM32		1	/* Target CPU type : STM32 group */
#define MTKBSP_CPU_STM32F7		1	/* Target CPU type : STM32F7 series */
#define MTKBSP_CPU_STM32F767		1	/* Target CPU      : STM32F767 */
...
#define TARGET_DIR	stm32_cube/nucleo_stm32f767	/* Sysdepend-Directory name */
