 ...
 *	machine.h
 *
 *	Machine type definition (NUCLEO STM32H723)
 */
...
/* ----- MUCLEO STM32H723 (CPU: STM32H723ZG) definition ----- */
#define MTKBSP_STM32CUBE		1	/* Target system   : STM32Cube */
#define MTKBSP_NUCLEO_STM32H723		1	/* Target Board    : NUCLEO STM32H7 */

#define MTKBSP_CPU_STM32		1	/* Target CPU type : STM32 group */
#define MTKBSP_CPU_STM32H7		1	/* Target CPU type : STM32H7 series */
#define MTKBSP_CPU_STM32H723		1	/* Target CPU      : STM32H723 */
...
#define TARGET_DIR	stm32_cube/nucleo_stm32h723	/* Sysdepend-Directory name */
