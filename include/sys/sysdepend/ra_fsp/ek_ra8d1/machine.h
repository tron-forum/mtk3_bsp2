 ...
 *	machine.h
 *
 *	Machine type definition (EK-RA8D1)
 */
...
#define TARGET_DIR	ra_fsp/ek_ra8d1	/* Sysdepend-Directory name */
#define TARGET_GRP_DIR	ra_fsp		/* Sysdepend-Group-Directory name */
#define	TARGET_CPU_DIR	ra8d1		/* Sysdepend-CPU-Directory name */
