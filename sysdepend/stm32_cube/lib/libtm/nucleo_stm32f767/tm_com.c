...
/*
 *    tm_com.c
 *    T-Monitor Communication low-level device driver (Nucleo STM32F767)
 */
...
#ifdef MTKBSP_NUCLEO_STM32F767
#if TM_COM_SERIAL_DEV

/* UART register definition (Use USART3) */
#define	UART_BASE	(0x40004800UL)		/* USART3 register base address */
